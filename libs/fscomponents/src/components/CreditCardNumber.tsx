...
import { Image, ImageStyle, ImageURISource, StyleProp, StyleSheet, View } from 'react-native';
import {
  TextInputMask,
...
export class CreditCardNumber extends Component<CreditCardNumberProps, CreditCardNumberState> {
  constructor(props: CreditCardNumberProps) {
    ...
    const cardType = determineCardType(props.value, {
      allowPartial: true,
    }) as CreditCardType;
  ...
  render(): React.ReactNode {
    ...
    return (
      <View style={styles.container}>
        <Image source={icons[cardType]} style={[styles.cardImage, this.props.cardImageStyle]} />
        <TextInputMask
          {...textInputProps}
          type="custom"
  ...
  onChangeText = (text: string) => {
    const cardType = determineCardType(text, {
      allowPartial: true,
    }) as CreditCardType;

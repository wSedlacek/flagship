...
interface CarouselOptions
  extends Pick<
    CarouselProperties<any>,
    'inactiveSlideScale' | 'inactiveSlideOpacity' | 'activeSlideAlignment'
  > {
...
// extends CardProps
export default class DemoProductCarouselBlock extends Component<
  DemoProductCarouselBlockProps,
  DemoProductCarouselBlockState
> {
  ...
  _renderItem = (data: { item: RenderDemoProductData; index: number }): JSX.Element => {
    return (
      <RenderDemoProduct
        data={data.item}
        index={data.index}
  ...
  render(): JSX.Element {
    ...
    return <View style={containerStyle}>{carousel}</View>;
  }
}
